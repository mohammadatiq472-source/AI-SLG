...
def add_cover_page(doc, title_type, title_name):
    ...
    for label, spaces in fields:
        p = doc.add_paragraph()
        p.alignment = WD_ALIGN_PARAGRAPH.CENTER
        run = p.add_run(label + spaces)
...
def create_essay():
    ...
    refs = [
        ...
        '[2] 中山市统计局. 中山统计年鉴2024[M]. 北京: 中国统计出版社, 2024.',
        '[3] 广东省人民政府. 粤港澳大湾区发展规划纲要实施情况报告[R]. 2023.',
        '[4] 中山火炬高技术产业开发区统计局. 火炬开发区2024年国民经济和社会发展统计公报[R]. 2025.',
